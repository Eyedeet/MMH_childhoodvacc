...
write.table(results_DTP, paste0(results, "aft_results_DTP_sensitivity_CC.csv"), sep = "\t", row.names = T,
            dec = ".")
...
results_DTP[, TR:= paste0(round(1/Estimate, digits = 2), " (", round(1/uci, digits = 2), "-", round(1/lci, digits = 2), ")")]
write.table(results_DTP, paste0(results, "aft_results_PCV3_sensitivity_CC.csv"), sep = "\t", row.names = T,
            dec = ".")
...
results_DTP[, TR:= paste0(round(1/Estimate, digits = 2), " (", round(1/uci, digits = 2), "-", round(1/lci, digits = 2), ")")]
write.table(results_DTP, paste0(results, "aft_results_MMR2_sensitivity_CC.csv"), sep = "\t", row.names = T,
            dec = ".")
